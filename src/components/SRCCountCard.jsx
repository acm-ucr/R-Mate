    ...
    <View className="bg-rmate-white m-2 p-3 rounded-xl">
      <View className="flex justify-between flex-row">
        <View className="flex justify-between">
          <View className="flex">
            <Text className="text-rmate-blue font-poppins-600">
              Basketball (Lower Court)
            </Text>
            <Text className="text-[#44B300] font-poppins-400">(Open)</Text>
          </View>
          <Text className="text-rmate-blue font-poppins-400">
            Last Count: 42
          </Text>
        </View>
        ...
        <View>
          ...
          >
            {(fill) => (
              <Text className="font-poppins-500 text-md text-rmate-blue">
                {fill}%
              </Text>
            )}
          </CircularProgress>
