    ...
    <View className="flex flex-row justify-center m-2">
      <View className="w-full flex flex-row bg-rmate-lightblue rounded-xl p-2">
        <View className="w-2/3">
          <Text className="text-rmate-black text-lg justify-self-start font-poppins-400 font-normal">
            {departmentName}
          </Text>
          <Text className="text-rmate-blue text-sm justify-self-start font-poppins-300 font-light">
            {phoneNum}
          </Text>
        </View>
