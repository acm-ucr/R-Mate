  ...
  return (
    <View className="w-full flex justify-center items-center">
      ...
      <View className="w-11/12 mt-4">
        <Text className="bg-rmate-yellow rounded-full px-4 py-2 w-fit text-black font-poppins_600">
          General
        </Text>
        ...
        <Text className="bg-rmate-yellow rounded-full px-4 py-2 w-fit text-black mt-4 font-poppins_600">
          Feedback
        </Text>
